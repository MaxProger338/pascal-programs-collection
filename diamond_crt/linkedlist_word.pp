...
procedure CreateList(var myNode: Nodeptr; data: word);
procedure DeleteList(myNode: Nodeptr);
function  GetSize(myNode: Nodeptr): word;
procedure AddNode(var myNode: Nodeptr; data: word);
procedure RemoveNode(var myNode: Nodeptr);
function  GetNode(myNode: Nodeptr; index: word): word;
procedure SetNode(myNode: Nodeptr; index: word; data: word);
